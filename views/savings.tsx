            ...
            <div className="flex justify-between items-center mt-2">
                <div className="flex items-center space-x-3">
                    <button
                        ...
                        className="p-2 bg-[#111111] rounded-full text-gray-400"
                    >
                        <ChevronLeft size={20} />
                    </button>
            ...
            <div className="space-y-3">
                {monthSavings.length === 0 ? (
                    ...
                    monthSavings.map(s => (
                        <div
                            key={s.id}
                            className="flex items-center justify-between p-4 bg-[#0E1621]/40 border border-[#1F1F1F] rounded-3xl"
                        >
                    ...
                    <div className="bg-[#0E1621] border border-[#1F1F1F] p-8 rounded-[3rem] w-full max-w-sm space-y-8 animate-in zoom-in duration-300">
                        ...
                        <div className="space-y-4">
                            <div className="text-center">
                                ...
                                />
                                <p className="text-[10px] text-gray-600 font-bold mt-2 tracking-widest uppercase">
                                    Amount in BDT
                                </p>
                            </div>
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="flex-1 py-4 bg-[#1F1F1F] rounded-2xl font-bold text-sm"
                            >
                                {t('cancel')}
                            </button>
                            <button
                                onClick={handleAdd}
                                className="flex-1 py-4 bg-emerald-500 rounded-2xl font-bold text-sm text-black"
                            >
                                {t('save')}
                            </button>
                        </div>
